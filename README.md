...
The designs are in JPG static format. This will mean that you'll need to use your best judgment for styles such as `font-ddisize`, `pang` and `margin`. This should help train your eye to perceive differences in spacings and sizes.
